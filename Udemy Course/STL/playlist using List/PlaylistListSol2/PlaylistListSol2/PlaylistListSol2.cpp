...
int main()
{
	...
	do
	{
		...
		if (selection == 'F')					// F - Play First Song
		{
			std::cout << "Playing first song" << std::endl;
			current_song = playlist.begin();
			play_current_song(*current_song);
		}
		else if (selection == 'N')				// N - Play Next song
		{
		...
		else if (selection == 'P')				// P - Play Previous song
		{
		...
		else if (selection == 'A')				// A - Add and play a new Song at current location
		{
		...
		else if (selection == 'L')				// L - List the current playlist
		{
			std::cout << std::endl;
			display_playlist(playlist, *current_song);
		}
		else if (selection == 'Q')				// Enter a selection (Q to quit)
		{
	...
	std::cout << "Tankg for listening!" << std::endl;
	return 0;
}
